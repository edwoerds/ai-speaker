...
```
上午 8:30~11:30   3h   写代码（新模块 + Review前一天）
下午 14:00~17:30  3.5h 写代码 + 加固（错误处理、超时、重试）
晚上 19:30~21:30  2h   加餐（Linux命令30min + C基础60min + 灵活30min）
```
